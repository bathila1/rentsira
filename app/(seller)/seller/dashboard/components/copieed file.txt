...
export default function Dashboard() {
  ...
  async function fetchVehicles(userId: string) {
    ...
    const { data, error } = await supabase
      ...
      .select(
        "id, make, model, type, year, daily_rate, image_urls, view_count, bumped_until, district, is_verified",
      )
      .eq("seller_id", userId)
                    ...
                    >
                      {v.is_verified && (
                        <Link
                          ...
                          className="btn btn-secondary btn-esm"
                        >
                          👁️ View
                        </Link>
                      )}
                      <Link
                        ...
                        className="btn btn-ghost btn-esm"
                      >
                        ✏️ Edit
                      </Link>
                      {v.is_verified && (
                      ...
                      <button
                        ...
                        className="btn btn-danger btn-esm"
                      >
                      ...
                      <div>
                        <span
                          className={`status-badge ${v.is_verified ? "is-verified" : "is-unverified"}`}
                        >
