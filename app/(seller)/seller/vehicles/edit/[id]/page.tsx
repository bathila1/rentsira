        ...
        <form onSubmit={handleUpdate} style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-5)' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 'var(--space-4)' }}>
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="e.g. Premio" required
                  className="input"
                />
              </div>
          ...
          <div className="section-card">
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 'var(--space-4)' }}>
              <div>
                <label className="form-label">Daily Rate <span className="required">*</span></label>
                <input
                  type="number" value={form.dailyRate}
              ...
              <div>
                ...
                <input
                  type="number" value={form.weeklyRate}
              ...
              <div>
                ...
                <input
                  type="number" value={form.monthlyRate}
            ...
            >
              <div className={`driver-toggle-check ${form.withDriver ? 'active' : ''}`}>
                {form.withDriver && '✓'}
              </div>
              <div>
                <p style={{ fontSize: '0.875rem', fontWeight: 600, color: 'var(--text-primary)' }}>
