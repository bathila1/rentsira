...
export default function EditImagesPage() {
  ...
  const handleReplaceImage = async (
    ...
    // We take 12 bytes now to properly verify WebP
    ...
    // Checks for RIFF at start AND "WEBP" at the correct offset
    const isWebp =
      hex.startsWith("52494646") && hex.slice(16, 24) === "57454250";

    if (!isJpeg && !isPng && !isWebp) {
      alert("Invalid image file. Please use a different image.(PNG/JPG/JPEG/WEBP supported)");
      return;
    }
    ////////////////////////
    ...
    <div className="page" style={{ paddingBottom: "var(--space-16)" }}>
      <div className="container-sm" style={{ paddingTop: "var(--space-8)" }}>
        ...
        >
          ...
          >
            Click <strong>Replace</strong> under any photo to swap it. The first
            image is your <strong>cover photo</strong> shown in listings.
          </p>
        </div>
                  ...
                  style={{
                    ...
                    color:
                      uploadingIndex === index
                        ...
                        : "var(--text-secondary)",
                    cursor:
                      uploadingIndex === index ? "not-allowed" : "pointer",
        ...
        {imageUrls.length === 0 && (
          <div className="empty-state">
            ...
            <p className="empty-state-sub">
              This vehicle has no photos attached
            </p>
          </div>
        )}
