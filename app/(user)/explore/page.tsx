    ...
    <div className="page">
      ...
      <div className="container" style={{ padding: 'var(--space-8) var(--space-4)' }}>
        ...
        <div style={{ marginBottom: 'var(--space-6)' }}>
          <p className="label" style={{ marginBottom: 'var(--space-1)' }}>Sri Lanka</p>
          <div style={{
            ...
            <p style={{ fontSize: '0.875rem', color: 'var(--text-tertiary)' }}>
              {totalCount.toLocaleString()} vehicle{totalCount !== 1 ? 's' : ''} available
              {userLat && (
                <span style={{
        ...
        {vehicles.length === 0 ? (
          <div className="empty-state">
            ...
            <p className="empty-state-sub">Try adjusting or clearing your filters</p>
          </div>
        ) : (
          // ─── Vehicle Grid ───
